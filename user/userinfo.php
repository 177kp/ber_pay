...
<?php if($mod=='api'){?>
			<form class="form-horizontal devform">
				...
				<div class="form-group">
				  <div class="col-sm-offset-2 col-sm-4"><a href="https://berf1.cn/mbvnH4" class="btn btn-sm btn-success" target="_blank">查看开发文档</a>&nbsp;&nbsp;<a href="javascript:resetKey()" class="btn btn-sm btn-danger">重置密钥</a>
				 </div>
				</div>
			</form>
