...
");
            ...
            $step=3;
			@file_put_contents("install.lock",'BER分支付系统安装锁');
			clearpack();
        }
    }
}
...
<div class="container"><br>
    ...
    <footer class="footer">
        <pre><center>Powered by <a href="https://www.berfen.com/" target="_blank">BER分</a> </center></pre>
    </footer>
</div>
</body>
</html>
