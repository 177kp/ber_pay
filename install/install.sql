...
INSERT INTO `pre_config` VALUES ('sitename', 'BER分支付系统');
INSERT INTO `pre_config` VALUES ('title', 'BER分支付系统');
INSERT INTO `pre_config` VALUES ('keywords', 'BER分支付系统,支付宝免签约即时到账,财付通免签约,微信免签约支付,QQ钱包免签约,免签约支付');
INSERT INTO `pre_config` VALUES ('description', 'BER分支付系统，完美解决支付难题，一站式接入支付宝，微信，财付通，QQ钱包,微信wap，帮助开发者快速集成到自己相应产品，效率高，见效快，费率低！');
INSERT INTO `pre_config` VALUES ('orgname', '院主网络科技团队');
...
INSERT INTO `pre_config` VALUES ('transfer_name', 'BER分支付系统');
INSERT INTO `pre_config` VALUES ('transfer_desc', '支付自动结算');
